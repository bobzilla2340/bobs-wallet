...
import cs2340.bobzilla.bobs_wallet.exceptions.
    InvalidTransactionCreationException;
...
public class UserFinanceAccountActivityPresenter implements ClickListener {
    ...
    /**
     * This is the reference to the view that is tied to
     * this presenter class.
     */
    private UserFinanceAccountActivityView view;
    /**
     * This is a reference to a decimal formatter in order
     * to format money.
     */
     ...
     * corresponding view.
     *
     * @param inputView - the view to be tied to the presenter.
     */
     ...
     *
     * @throws InvalidTransactionCreationException - occurs when
    ...
    public final ArrayList<String> getFormattedTransactions(
        ...
        for (Transaction t : transactions) {
            ...
            display = display + df.format(t.getAmount()) + "\t\t"
                    + t.getCategory() + "\t\t" + t.getTransactionDate();
    ...
    /**
     * This method gets the current account balance and formats
     * it to the appropriate monetary format.
     * @param accountName - the name of the account to get the balance
     * from.
     * @return formattedAccountBalance - the balance of the account in
     * formatted with the appropriate monetary symbol.
     */
