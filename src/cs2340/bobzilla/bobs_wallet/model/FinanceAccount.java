...
public class FinanceAccount implements Serializable {
    ...
    /**
     * Constructs a FinanceAccount with an accountName and an
     * interest rate.
     * @param accountName, the String accountName
     * @param interest, the double interest
     */
     ...
     * @param interest, the double interest rate
     */
     ...
     * @param type, the TransactionType type
