...
public class DatePickerFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mDateType = getArguments()
                .getString(UserAccountActivity.EXTRA_DATETYPE);
        try {
        ...
        // Retrieves DatePicker and sets a listener to retrieve the date the
        // user
        // inputed
        ...
        AlertDialog.Builder result = new AlertDialog.Builder(getActivity())
                .setView(v).setPositiveButton(android.R.string.ok,
                        new DialogInterface.OnClickListener() {
                            ...
                            // Whenever the user is satisfied with the date, the
                            // hosting activity's
                            // onDateChange method is called (this was from the
                            // interface defined above)
                            // to pass to the hosting activity the date and date
                            // type.
                            @Override
