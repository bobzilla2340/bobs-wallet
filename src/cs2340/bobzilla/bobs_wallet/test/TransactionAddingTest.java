...
public class TransactionAddingTest extends TestCase {
    ...
    /**
     * This is the amount put into the finance account
     * when testing the withdrawal feature.
     */
    public static final int TEST_WITHDRAWAL_AMOUNT1 = 1332;
    /**
     * This is an amount that is used when testing the
     * withdrawal feature.
     */
    public static final double TEST_WITHDRAWAL_AMOUNT2 = 100;
    /**
     * This is the amount that is balance of the finance
     * account after withdrawal amount 1.
     */
    public static final double TEST_WITHDRAWAL_BALANCE1 = -1332.0;
    /**
     * This is an amount that denotes the balance
     * of the finance account after withdrawal amount 2.
     */
    public static final double TEST_WITHDRAWAL_BALANCE2 = -131.0;
    /**
     * This is the amount that is initially placed in the
     * finance account.
     */
    ...
    public final void testWithdrawal() {
        ...
        assertEquals(TEST_WITHDRAWAL_BALANCE1,
    ...
    /**
     * This method will test the deposit feature of the
     * finance account.
     */
    public final void testDeposit() {
        ...
        assertEquals(TEST_DEPOSIT_BALANCE1,
                testAccount.getCurrentBalance());
    ...
    public final void testBoth() {
        ...
        testAccount.addTransaction(TEST_DEPOSIT_AMOUNT2,
                TransactionType.DEPOSIT, "fun");
        assertEquals(TEST_DEPOSIT_BALANCE2,
                testAccount.getCurrentBalance());
        assertEquals("testing", testAccount.getAccountName());
        assertEquals(0.0, testAccount.getInterestRate());
        assertEquals(1, testAccount.getDeposits().size());
