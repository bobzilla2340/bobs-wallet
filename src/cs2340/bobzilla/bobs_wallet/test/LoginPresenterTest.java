...
public class LoginPresenterTest extends TestCase {
    ...
    private LoginActivityPresenter presenter0, presenter1, presenter2,
    ...
    public void setUp() {
        ...
        User user1 = new User("sai", "sai", "paladugu", "12345",
                "spaladugu3@gatech.edu");
        User user2 = new User("lumberjack", "lumber", "jack", "5555",
                "lumberjack@tree.com");
        User user3 = new User("awesome", "awesome", "awesome", "awesome",
                "awesome@awesome.com");
        list.addUser(user1);
        list.addUser(user2);
        list.addUser(user3);
