...
public class LoginVerifier {
    ...
    /**
     * Verifies if the password for the given userName equals the password for
     * the userName in the userList.
     * 
     * @param userList
     *            , the UserList userList
     * @param userName
     ...
     * @return boolean T or F
     */
    public static boolean veirfyUserPassword(UserList userList,
