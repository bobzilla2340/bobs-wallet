...
/**
 * This interface defines a contract to any class
 * that keeps track or otherwise can get access to
 * the list of all users that use the application.
 *
 * @author sai
 *
 */
public interface UserListModel {
    ...
    /**
     * This method allows the access of a
     * particular user.
     * @param user
     *          The user to be accessed.
     * @return the user object that corresponds
     *      to the user that was searched for.
     */
    User getUser(String user);

    /**
     * This method allows us to see if a user is in the
     * user list by using the user name stirng.
     * @param user
    ...
    /**
     * This method allows us to see if a user in the
     * user list by using the user object.
     * @param user
